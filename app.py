...
### 文体ルール（厳守）
- **reason**: 1行・20〜40字以内・体言止め。「〜のため非該当」「〜の可能性あり、要確認」など結論＋一言理由のみ。長い説明不要。
- **recommendation**: 担当者が"次に何をすべきか"を1行・30字以内で。例：「対比表でSTEP1を突合し、非該当を確定する」「許可申請の要否を上長に確認」
- **unverifiable**: 短い名詞句のみ（10字以内推奨）。例：「用途の真偽」「再輸出の有無」「エンドユーザー確認」
- **caution**: 省略可。書く場合も1行以内。

{
  "overall": "OK" または "要確認" または "要許可",
  "steps": [
    {"step": 1, "title": "別表第1（1〜15項）", "result": "非該当" または "要確認" または "該当", "reason": "1行・体言止め", "confidence": "高" または "中" または "低"},
    {"step": 2, "title": "16項（キャッチオール）", "result": "非該当" または "要確認" または "該当", "reason": "1行・体言止め", "confidence": "高" または "中" または "低"},
    {"step": 3, "title": "仕向地（別表第3）", "result": "ホワイト国" または "非ホワイト国" または "指定国", "reason": "1行・体言止め", "confidence": "高" または "中" または "低"},
    {"step": 4, "title": "用途確認（キャッチオール）", "result": "非該当" または "要確認" または "該当" または "スキップ", "reason": "1行・体言止め", "confidence": "高" または "中" または "低"},
    {"step": 5, "title": "総合判断", "result": "問題なし" または "要精査" または "輸出不可", "reason": "1行・体言止め", "confidence": "高" または "中" または "低"}
  ],
  "unverifiable": ["短い名詞句のみ"],
  "recommendation": "次のアクション1行",
  "hs_hint": "推定HSコード（番号のみ、例：7606.12）",
  "caution": ""
}"""
...
DOC_REFS = [
    {
        "id": "matrix",
        "name": "貨物・技術のマトリクス表（該非判定）",
        "url": "https://www.meti.go.jp/policy/anpo/matrix_intro.html",
        "desc": "リスト規制（STEP1）判定の基準。製品仕様を突合する公式資料",
    },
    {
        "id": "anpo_top",
        "name": "安全保障貿易管理（経産省トップ）",
        "url": "https://www.meti.go.jp/policy/anpo/",
        "desc": "法令・規制・通知の最新情報。まず確認するページ",
    },
    {
        "id": "whitelist",
        "name": "仕向地・グループA（ホワイト国）",
        "url": "https://www.meti.go.jp/policy/anpo/apply08.html",
        "desc": "キャッチオール通常兵器免除対象国リスト（STEP3）の確認ページ",
    },
    {
        "id": "catchall",
        "name": "補完的輸出規制（キャッチオール規制）",
        "url": "https://www.meti.go.jp/policy/anpo/catchall.html",
        "desc": "大量破壊兵器・通常兵器の用途規制（STEP2）の詳細基準",
    },
    {
        "id": "egov_law",
        "name": "輸出貿易管理令（e-Gov法令検索）",
        "url": "https://laws.e-gov.go.jp/law/324CO0000000378/",
